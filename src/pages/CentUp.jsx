    ...
    return (
        <section className="sectionCentUp w-100">
            ...
            <div className="container text-center centup-wrapper">
                ...
                <div className="centup-mockup-box mb-3">
                    <img 
                        src={simulazioneGif} 
                ...
                <div className="github-link-section mb-5">
                    <a 
                        href="https://github.com/alexa109445/centup-frontend" 
                        target="_blank" 
                        rel="noopener noreferrer" 
                        className="github-centup-btn"
                    >
                ...
                <div className="centup-funzionamento mb-5 pb-5 border-bottom-divisore">
                    ...
                    <div className="row align-items-center justify-content-center text-start grid-funzionamento">
                        <div className="col-lg-4 col-md-12 d-flex flex-column align-items-center mb-4 text-column">
                        ...
                        <div className="col-lg-3 col-md-12 d-flex flex-column align-items-center mb-4 freccia-column text-center">
                ...
                <div className="centup-sections-container">
                    
                    <div className="centup-row-section mb-5 pb-5 border-bottom-divisore text-start">
                        <div className="row align-items-center">
                            <div className="col-12 col-lg-6 text-center mb-4 mb-lg-0">
                                <img 
                                    ...
                                    className="img-slide-preview shadow img-fluid" 
                                />
                            </div>
                    ...
                    <div className="centup-row-section mb-5 pb-5 border-bottom-divisore text-start">
                        <div className="row align-items-center">
                            ...
                            <div className="col-12 col-lg-6 px-4">
                                ...
                                <p className="funzionamento-testo mb-4">
                                    Con un semplice tocco sulla lista degli enti disponibili, i risparmi accumulati vengono inviati istantaneamente all'organizzazione scelta. Questo sistema trasforma i piccoli centesimi messi da parte in un aiuto concreto, immediato e sicuro per le cause che stanno più a cuore all'utente.
                                </p>
                                <div className="obiettivi-tech-box p-4 rounded">
                                    <div className="d-flex align-items-start mb-3">
                                        <span className="fs-4 me-3">⚛️</span>
                    ...
                    <div className="centup-row-section mb-5 pb-5 border-bottom-divisore text-start">
                        <div className="row align-items-center">
                            <div className="col-12 col-lg-6 text-center mb-4 mb-lg-0">
                                <img 
                                    src={imgAccedi} 
                                    alt="Interfaccia di acesso sicuro CentUp" 
                                    className="img-slide-preview shadow img-fluid" 
                                />
                            </div>
                            <div className="col-12 col-lg-6 px-4">
                                <h2 className="centup-titolo mb-4 text-center text-lg-start">Struttura semplice e sicura ⛓️</h2>
                                <p className="funzionamento-testo mb-3">
                                ...
                                <div className="obiettivi-tech-box p-4 rounded">
                                    <div className="d-flex align-items-start mb-3">
                                        <span className="fs-4 me-3">⚛️</span>
                                        <p className="tech-box-testo m-0">
                                            <strong>React: Protezione dati in uscita:</strong> Gestione sicuro dei moduli di input e invio crittografato delle credenziali verso il server per evitare intercettazioni.
                                        </p>
                                    </div>
                                    <div className="d-flex align-items-start">
                                        <span className="fs-4 me-3">☕</span>
                                        <p className="tech-box-testo m-0">
                                            <strong>Java: Blindatura con Spring Security:</strong> Utilizzo dell'algoritmo BCrypt: le password non vengono mai salvate in chiaro nel database, ma memorizzate in una versione criptata e indecifrabile.
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="centup-tecnologie text-center pt-5">
                    ...
                    <div className="row justify-content-center text-start px-2 tech-grid">
                        ...
                        <div className="col-12 col-md-4 mb-5 d-flex flex-column justify-content-between px-4 tech-col">
                            <div>
                                ...
                                <h4 className="tech-lista-titolo mb-3">React.js, JavaScript, Bootstrap e CSS.</h4>
                            ...
                            <div className="text-center mt-4 img-tech-container">
