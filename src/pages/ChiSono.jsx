        ...
        <section className="sectionChiSono w-100">
            ...
            <div className="container-fluid px-5">
                <div className="row align-items-center justify-content-center">
                    ...
                    <div className="col-12 col-lg-5 px-4 mb-5 mb-lg-0 d-flex flex-column align-items-center">
                    ...
                    <div className="col-12 col-lg-5 px-4 d-flex flex-column align-items-center">
                        <div className="w-100 text-center">
                            <h1 className="cs-titolo-destro mb-4">La mia formazione 👩🏻‍💻</h1>
                        ...
                        <div className="cs-spaziatore-valore w-100 text-center">
                            <p className="cs-testo mb-0">
